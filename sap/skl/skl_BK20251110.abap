...
*        l_betpe  =  100000 * xmb1.
*
*      ELSEIF l_count > 30 AND l_count <= 180.
*
*        IF l_previous  >= 30.
*
*          l_betpe  =  100000 * xmb2.
...
*        ELSE.
*
*          l_betpe  = 100000 * ( ( 30 - l_previous ) * xmb1 +
*                  ( l_current - 30 + l_previous ) * xmb2 ) / l_current.
*
*        ENDIF.
*
*      ELSEIF l_count > 180.
...
*        ELSE.
*
*          l_betpe  = 100000 * ( ( 180 - l_previous ) * xmb2 +
*                  ( l_current - 180 + l_previous ) * xmb3 ) / l_current.
*
*        ENDIF.
*
*      ENDIF.
